                ...
                c => new
                    {
                        ...
                        Message = c.String(),
                        ParallelInformation_IsExist = c.String(),
                        ParallelInformation_SerialNumber = c.String(),
                        ParallelInformation_WorkMode = c.String(),
                        ParallelInformation_FaultCode = c.String(),
                        ParallelInformation_GridVoltage = c.String(),
                        ParallelInformation_GridFrequency = c.String(),
                        ParallelInformation_ACOutputVoltage = c.String(),
                        ParallelInformation_ACOutputFrequency = c.String(),
                        ParallelInformation_ACOutputApparentPower = c.String(),
                        ParallelInformation_ACOutputActivePower = c.String(),
                        ParallelInformation_LoadPercentage = c.String(),
                        ParallelInformation_BatteryVoltage = c.String(),
                        ParallelInformation_BatteryChargingCurrent = c.String(),
                        ParallelInformation_BatteryCapacity = c.String(),
                        ParallelInformation_PV_InputVoltage = c.String(),
                        ParallelInformation_TotalChargingCurrent = c.String(),
                        ParallelInformation_Total_AC_OutputApparentPower = c.String(),
                        ParallelInformation_TotalOutputActivePower = c.String(),
                        ParallelInformation_Total_AC_OutputPercentage = c.String(),
                        SCC_OK = c.String(),
                        AC_Charging = c.String(),
                        SCC_Charging = c.String(),
                        Battery = c.String(),
                        Line_OK = c.String(),
                        loadOn = c.String(),
                        ConfigurationChange = c.String(),
                        ParallelInformation_OutputMode = c.String(),
                        ParallelInformation_ChargerSourcePriority = c.String(),
                        ParallelInformation_MaxChargerCurrent = c.String(),
                        ParallelInformation_MaxChargerRange = c.String(),
                        ParallelInformation_Max_AC_ChargerCurrent = c.String(),
                        ParallelInformation_PV_InputCurrentForBattery = c.String(),
                        ParallelInformation_BatteryDischargeCurrent = c.String(),
                        ...
                        SPM90Voltage = c.String(),
                        SPM90Current = c.String(),
                        SPM90ActivePower = c.String(),
                        SPM90ActiveEnergy = c.String(),
                        SPM90VoltageDirection = c.String(),
                        CreateTime = c.DateTime(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
